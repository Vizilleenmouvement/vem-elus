...
.layout{display:flex;flex-direction:row;width:100%;height:calc(100vh - var(--th));overflow:hidden;position:relative;}
...
function openPanel(id){
  ...
  if(!panel){
    ...
    panel.id = "main-panel";
    panel.style.cssText = "position:absolute;left:0;right:0;top:0;bottom:0;z-index:100;display:flex;flex-direction:column;overflow:hidden;background:var(--w);";
...
function renderElus(){
  ...
  el2.innerHTML=list.map(function(e,i){
    var photoHtml=e.photo
      ?'<img loading="lazy" src="'+e.photo+'" style="width:100%;height:100%;object-fit:cover;object-position:'+(e.photoPos||"center center")+'" onerror="this.style.display=\'none\';if(this.nextSibling)this.nextSibling.style.display=\'flex\'">'
...
function openElu(i){
  ...
  var av='<div style="width:64px;height:64px;border-radius:12px;background:'+col+';display:flex;align-items:center;justify-content:center;font-size:1.2rem;font-weight:800;color:#fff;flex-shrink:0">'+e.avatar+'</div>';
  ...
  $("elu-det-b").innerHTML=
    ...
    +'</div>'
    +'<div><label style="font-size:.67rem;font-weight:700;color:var(--i3);display:block;margin-bottom:3px;text-transform:uppercase">Rôle</label><input id="ef-role" class="fi" value="'+(e.role||'')+'" placeholder="Adjoint, Conseillère déléguée…" style="font-size:.76rem;padding:6px 9px"></div>'
